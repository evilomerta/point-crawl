  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        width: "min(1240px, 97vw)", height: "min(80vh, 760px)",
        ...
        <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
          <div style={{ width: 260, borderRight: `1px solid ${PALETTE.gold}33`, overflowY: "auto", padding: "8px 0", display: "flex", flexDirection: "column" }}>
